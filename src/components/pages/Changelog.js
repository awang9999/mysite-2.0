                      ...
                      <div className='changelog-notes'>
                              ...
                              <li>
                                  <p>
                                      ...
                                      the following node packages to handle rendering
                                      markdown text and LaTeX: react-katex, react-markdown,
                                      rehype-katex, remark-gfm, and remark-math. Markdown
                                      components now translate to HTML components with customizable CSS
                                      using the remark/rehype pipelines. I'm excited to deliver
